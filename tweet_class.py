...
class Tweet:
    def __init__(self, type="", time_posted="", content="", associated_tweet_id="", comment=0, retweet=0, like=0, views=0):
        self.type = type
        self.time_posted = time_posted
        self.content = content
        self.associated_tweet_id = associated_tweet_id
    ...
    def to_dict(self):
        return {
            ...
            'associated_tweet_id': self.associated_tweet_id,
